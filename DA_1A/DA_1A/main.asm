...
;
.set multiplicand_hi = 0xFF   ; value given to high byte of multiplicand
.set multiplicand_lo= 0xFF    ; value given to low byte of multiplicand
.set multiplier = 0xFF        ; value givne to the multiplier
